...
export default class RouteTracker extends Component {
            ...
            <Container>
                <Content>
                    ...
                    <View style={{alignItems:'center',marginTop:30}}>
                        ...
                        <TouchableHighlight
                            onPress={() => { Linking.openURL(repoUrl).catch(err => console.error('An error occurred', err)); }}
                            underlayColor='#CCC' activeOpacity={0.8}>
                            <Text
                                style={[styles.text,{textAlign:'center',fontSize:12,color:'#00C',textDecorationLine:'underline'}]}>
                                {repoUrl}
                            </Text>
                        </TouchableHighlight>
                    </View>
                    ...
                    <View style={styles.row}>
                        <TouchableHighlight onPress={() => { Location.startUpdatingLocation() }}
                                            style={[styles.button,{backgroundColor:'#126312'}]}>
                            <Text style={[styles.text,{fontSize:30,color:'#fff'}]}>Start</Text>
                        </TouchableHighlight>

                        <TouchableHighlight onPress={() => { Location.stopUpdatingLocation() }}
